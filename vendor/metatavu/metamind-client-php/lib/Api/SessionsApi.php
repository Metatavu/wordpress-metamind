...
class SessionsApi
{
     ...
     * Creates new session
     *
     * @param  \Metatavu\Metamind\Api\Model\Session $body Payload (required)
     *
     * @throws \Metatavu\Metamind\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Metatavu\Metamind\Api\Model\Session
     */
     ...
     * @throws \Metatavu\Metamind\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Metatavu\Metamind\Api\Model\Session, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSessionWithHttpInfo($body)
    {
        $returnType = '\Metatavu\Metamind\Api\Model\Session';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Metatavu\Metamind\Api\Model\Session',
